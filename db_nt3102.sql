...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 24, 2023 at 02:12 PM
...
INSERT INTO `admin` (`adminID`, `empid`, `adminPassword`) VALUES
(1, 1001, 'password1'),
(2, 1002, 'password2'),
(3, 1003, 'password3');
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `fk_empid_admin` FOREIGN KEY (`empid`) REFERENCES `tbemployee` (`empid`);
